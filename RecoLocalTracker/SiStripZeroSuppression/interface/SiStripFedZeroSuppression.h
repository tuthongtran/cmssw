...
public:
  SiStripFedZeroSuppression(uint16_t fedalgo, edm::ConsumesCollector iC, bool trunc = true, bool trunc10bits = false)
      : noiseToken_(iC.esConsumes<SiStripNoises, SiStripNoisesRcd>()),
        thresholdToken_(iC.esConsumes<SiStripThreshold, SiStripThresholdRcd>()),
