...
process.TFileService.fileName = 'test_shallowTrackAndClusterFullInfoMC.root'
import sys
...
#    print(input)
#else:
#    process.TFileService.fileName = 'test_shallowTrackAndClusterFullInfoNoPU2016DatastripProp.root'
