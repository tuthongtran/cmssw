...
process.TFileService.fileName = 'test_shallowTrackClusterUP17CosmicsMC.root'
...
process.shallowTrackClusters.Tracks = 'TrackRefitter'
...
process.p = cms.Path(#process.MeasurementTrackerEvent*
                     ...
                     process.shallowTrackClusters*process.testTree)
