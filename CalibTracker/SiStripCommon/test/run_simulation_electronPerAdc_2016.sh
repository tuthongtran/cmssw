...
cmsRun trackCluster_test.py  electronPerAdc_min20_198.0step3.root #gets the on track clusters propertiesip
...
cmsRun trackCluster_test.py  electronPerAdc_min10_222.0step3.root #gets the on track clusters properties
...
cmsRun trackCluster_test.py  electronPerAdc_pl10_272.0step3.root #gets the on track clusters properties
...
cmsRun trackCluster_test.py  electronPerAdc_pl20_296.0step3.root #gets the on track clusters properties
...
cmsRun trackCluster_test.py  electronPerAdc_def_247.0step3.root #gets the on track clusters properties
