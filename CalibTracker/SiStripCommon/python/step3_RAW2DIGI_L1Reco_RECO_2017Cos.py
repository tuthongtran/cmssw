...
# with command line options: step3 --conditions auto:phase1_2017_cosmics -s RAW2DIGI,L1Reco,RECO --scenario cosmics --datatier GEN-SIM-RECO -n 10 --era Run2_2017 --eventcontent RECOSIM --filein file:step2.root --fileout file:step3.root --no_exec
