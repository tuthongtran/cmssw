...
# with command line options: step2 --conditions auto:phase1_2017_cosmics -s DIGI:pdigi_valid,L1,DIGI2RAW,HLT:@relval2017 --scenario cosmics --datatier GEN-SIM-DIGI-RAW -n 10 --era Run2_2017 --eventcontent FEVTDEBUG --filein file:step1.root --fileout file:step2.root --no_exec
