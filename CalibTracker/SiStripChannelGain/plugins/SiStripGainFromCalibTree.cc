...
{ 
	...
	//if(bin_max > -1){
	  ...
	  plhi[0]=100; plhi[1]=500.0; plhi[2]=1000000.0; plhi[3]=100;
	  sv[0]=25; sv[1]=300; sv[2]=InputHisto->Integral(); sv[3]=40;

	  Double_t chisqr;
	  Int_t    ndf;

	  TF1 *fitsnr = langaufit((TH1D *)InputHisto,fr,sv,pllo,plhi,fp,fpe,&chisqr,&ndf);
