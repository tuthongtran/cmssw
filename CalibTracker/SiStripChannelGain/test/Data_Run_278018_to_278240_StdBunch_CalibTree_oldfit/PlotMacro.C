...
// TH1D* MPV_Vs_PathlengthTECM2    = ChargeToMPV(Charge_Vs_PathlengthTECM2,"MPV_Vs_PathlengthTECM2", true);
   ...
   TH1D* ChargeWoG1     = new TH1D("ChargeWoG1"    ,"ChargeWoG1"    ,               687, 0,4000); 
   TH1D* ChargeWoG1TIB  = new TH1D("ChargeWoG1TIB" ,"ChargeWoG1TIB" ,               687, 0,4000);
   TH1D* ChargeWoG1TID  = new TH1D("ChargeWoG1TID" ,"ChargeWoG1TID" ,               687, 0,4000);
   TH1D* ChargeWoG1TOB  = new TH1D("ChargeWoG1TOB" ,"ChargeWoG1TOB" ,               687, 0,4000);
   TH1D* ChargeWoG1TEC  = new TH1D("ChargeWoG1TEC" ,"ChargeWoG1TEC" ,               687, 0,4000);
   
   TH1D* ChargeWoG1G2     = new TH1D("ChargeWoG1G2"    ,"ChargeWoG1G2"    ,               687, 0,4000); 
   TH1D* ChargeWoG1G2TIB  = new TH1D("ChargeWoG1G2TIB" ,"ChargeWoG1G2TIB" ,               687, 0,4000);
   TH1D* ChargeWoG1G2TID  = new TH1D("ChargeWoG1G2TID" ,"ChargeWoG1G2TID" ,               687, 0,4000);
   TH1D* ChargeWoG1G2TOB  = new TH1D("ChargeWoG1G2TOB" ,"ChargeWoG1G2TOB" ,               687, 0,4000);
   TH1D* ChargeWoG1G2TEC  = new TH1D("ChargeWoG1G2TEC" ,"ChargeWoG1G2TEC" ,               687, 0,4000);


   TH1D* ChargeWoG2     = new TH1D("ChargeWoG2"    ,"ChargeWoG2"    ,               687, 0,4000); 
   TH1D* ChargeWoG2TIB  = new TH1D("ChargeWoG2TIB" ,"ChargeWoG2TIB" ,               687, 0,4000);
   TH1D* ChargeWoG2TID  = new TH1D("ChargeWoG2TID" ,"ChargeWoG2TID" ,               687, 0,4000);
   TH1D* ChargeWoG2TOB  = new TH1D("ChargeWoG2TOB" ,"ChargeWoG2TOB" ,               687, 0,4000);
   TH1D* ChargeWoG2TEC  = new TH1D("ChargeWoG2TEC" ,"ChargeWoG2TEC" ,               687, 0,4000);


   TH1D* ChargePIB      = new TH1D("ChargePIB"     ,"ChargePIB"     ,               687, 0,4000);
   TH1D* ChargePIE      = new TH1D("ChargePIE"     ,"ChargePIE"     ,               687, 0,4000);
   TH1D* ChargeTIB      = new TH1D("ChargeTIB"     ,"ChargeTIB"     ,               687, 0,4000);
   TH1D* ChargeTID      = new TH1D("ChargeTID"     ,"ChargeTID"     ,               687, 0,4000);
   TH1D* ChargeTIDP     = new TH1D("ChargeTIDP"    ,"ChargeTIDP"    ,               687, 0,4000);
   TH1D* ChargeTIDM     = new TH1D("ChargeTIDM"    ,"ChargeTIDM"    ,               687, 0,4000);
   TH1D* ChargeTOB      = new TH1D("ChargeTOB"     ,"ChargeTOB"     ,               687, 0,4000);
   TH1D* ChargeTEC      = new TH1D("ChargeTEC"     ,"ChargeTEC"     ,               687, 0,4000);
   TH1D* ChargeTECP     = new TH1D("ChargeTECP"    ,"ChargeTECP"    ,               687, 0,4000);
   TH1D* ChargeTECM     = new TH1D("ChargeTECM"    ,"ChargeTECM"    ,               687, 0,4000);
   TH1D* ChargeTEC1     = new TH1D("ChargeTEC1"    ,"ChargeTEC1"    ,               687, 0,4000);
   TH1D* ChargeTEC2     = new TH1D("ChargeTEC2"    ,"ChargeTEC2"    ,               687, 0,4000);
   TH1D* ChargeTECP1    = new TH1D("ChargeTECP1"   ,"ChargeTECP1"   ,               687, 0,4000);
   TH1D* ChargeTECP2    = new TH1D("ChargeTECP2"   ,"ChargeTECP2"   ,               687, 0,4000);
   TH1D* ChargeTECM1    = new TH1D("ChargeTECM1"   ,"ChargeTECM1"   ,               687, 0,4000);
   TH1D* ChargeTECM2    = new TH1D("ChargeTECM2"   ,"ChargeTECM2"   ,               687, 0,4000);
/*
...
*/
   ...
   for (unsigned int ientry = 0; ientry < t1->GetEntries(); ientry++) {
      ...
      TH1D* ProjScaledG1     = new TH1D("projScaledG1"      ,"projScaledG1"    ,               687, 0,4000); 
      TH1D* ProjScaledG1G2   = new TH1D("projScaledG1G2"    ,"projScaledG1G2"  ,               687, 0,4000); 
      TH1D* ProjScaledG2     = new TH1D("projScaledG2"      ,"projScaledG2"    ,               687, 0,4000); 
