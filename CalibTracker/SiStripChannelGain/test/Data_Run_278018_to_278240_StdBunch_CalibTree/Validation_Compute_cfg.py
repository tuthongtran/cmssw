...
process.SiStripCalibValidation.calibrationMode     = cms.untracked.string( 'StdBunch' )
...
if(False):
   ...
   process.SiStripCalib.DQMdir         = cms.untracked.string('AlCaReco/SiStripGains')
   ...
   process.source = cms.Source("EmptyIOVSource",
       ...
       firstValue = cms.uint64(278018),
       lastValue  = cms.uint64(278240)
   )
